...
import { FaUser, FaRunning, FaBriefcase, FaYoutube, FaRegIdCard } from "react-icons/fa";
            ...
            {sections.map((section, index) => (
              <li key={section}>
                ...
                >
                  ...
                  {index === 2 && <FaBriefcase className="text-white text-lg" />}
      ...
      <div className="flex-1 p-6 bg-gray-50 text-black">
        <div className="bg-gray-200 border-l-4 border-verde-oscuro text-gray-700 p-4 max-w-7xl mx-auto text-center rounded-lg shadow-sm mb-6">
          <p className="font-semibold text-sm">
            Perfil del profesional de fútbol. Revisa los detalles de su información.
          </p>
        </div>

        {activeSection === "Perfil" && (
          <div className="p-6 bg-gray-50 text-gray-700 rounded-lg shadow-sm" data-aos="fade-up">
        ...
        {activeSection === "Datos Físicos" && (
          <div className="flex-1 p-6 bg-gray-50 text-gary-700 transition-opacity duration-300 rounded-lg shadow-sm" data-aos="fade-up">
