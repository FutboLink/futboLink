...
# Este script aplica el SQL para actualizar la tabla de aplicaciones
...
echo "Aplicando script SQL para actualizar la tabla de aplicaciones..."

# Ejecutar el script SQL
psql "$DB_URL" -f update-applications-table.sql
