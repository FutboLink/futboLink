...
function Subs() {
  ...
  const handleSubscribe = async (index: number, priceId: string) => {
    ...
    try {
      ...
      const successUrl = `${window.location.origin}/payment/success?plan=${encodeURIComponent(planName)}&session_id={CHECKOUT_SESSION_ID}`;
...
<h3 className={styles.title}>
  ...
  option.priceId.monthly && (
    <div className={styles.selectContainer}>
      ...
      <div className="mt-32 mb-10 rounded-2xl border border-[#3d7a26]/20 bg-gradient-to-br from-[#3d7a26] to-[#2f641f] p-6 sm:p-8 text-white shadow-lg">
