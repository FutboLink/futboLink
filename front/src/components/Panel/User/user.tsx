...
const UserProfile = () => {
  ...
  const [pendingSubscriptionType, setPendingSubscriptionType] = useState<
    string | null
  >(null);
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (cachedPendingType) {
        console.log(
          "Found cached pending subscription type:",
          cachedPendingType
        );
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (storedTrayectorias) {
        ...
        console.log(
          "Trayectorias encontradas en localStorage:",
          parsedTrayectorias
        );
  ...
  const handleViewCV = async () => {
    ...
    try {
      ...
      const isPdf =
        userData.cv.toLowerCase().includes(".pdf") ||
        userData.cv.toLowerCase().includes("/pdf/");
      ...
      try {
        ...
        if (error instanceof Error && error.message.includes("401")) {
          ...
          if (
            userData.cv.startsWith("http://") ||
            userData.cv.startsWith("https://")
          ) {
      ...
      if (error instanceof Error) {
        if (
          ...
          errorMessage =
            "Error 401: No se puede acceder al PDF directamente desde Cloudinary. Se intentará usar el visor de Google Docs.";
      ...
      if (userData.cv) {
        ...
        if (isPdfUrl) {
          console.log(
            `${errorMessage}. Intentando con visor de Google Docs como alternativa.`
          );
          const googleViewerUrl = `https://docs.google.com/viewer?url=${encodeURIComponent(
            userData.cv
          )}&embedded=true`;
          ...
          alert(
            "Se está intentando abrir el PDF con el visor de Google Docs como alternativa."
          );
          return;
        }
      }
        ...
        <div className="mb-8 flex flex-col items-center space-y-4">
          <div className="relative">
            <Image
              src={
                userData
                  ? userData.imgUrl || getDefaultPlayerImage(userData.genre)
      ...
      <div className="flex-1 p-1">
        ...
        {isClient ? (
          <>
            {activeSection === "profile" && (
              <div
                className="p-6 bg-gray-50 text-gray-700 rounded-lg shadow-sm mt-4"
                data-aos="fade-up"
              >
                        ...
                        {userData?.isVerified ? (
                          ...
                          <div>
                            <p className="text-sm text-gray-600 mb-3">
                              La verificación de perfil te ayuda a destacar y
                              generar mayor confianza con los reclutadores.
                            </p>
                            <button
                      ...
                      <div className="border border-gray-300 bg-gray-50 p-4 rounded-md w-full md:w-1/2 mb-4">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">
                              Puedes agregar tu CV en la sección de editar
                              perfil
                            </p>
                          </div>
                        </div>
            ...
            {activeSection === "skills" && (
              <div
                className="flex-1 p-6 bg-gray-50 text-gary-700 transition-opacity duration-300 rounded-lg shadow-sm mt-4"
                data-aos="fade-up"
              >
                ...
                {userData?.trayectorias && userData.trayectorias.length > 0 ? (
                  ...
                  <div className="border border-[#1d5126] bg-[#f5f5f5] p-4 rounded-md shadow-sm">
                    <h4 className="font-semibold text-lg text-gray-800">
                      {userData.club || "Club no especificado"}
                    </h4>
                    <div className="flex flex-wrap gap-4 mt-2 text-gray-700">
                      {userData.fechaInicio && (
                        <p className="bg-white px-3 py-1 rounded-full text-sm">
                          <span className="font-medium">Inicio:</span>{" "}
                          {new Date(userData.fechaInicio).toLocaleDateString(
                            "es-ES"
                          )}
                        </p>
                      )}
            ...
            {activeSection === "config" && (
              <div
                ...
                data-aos="fade-up"
              >
                <h3 className="text-xl font-semibold mb-6 text-[#1d5126] border-b pb-2">
                  Configuración
                </h3>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-yellow-700">
                          ...
                          confirma la autenticidad de tu información y te ayuda
                          a destacar ante reclutadores. Solo está disponible
                          para usuarios con suscripción Semiprofesional o
                          Profesional activa.
                        </p>
                      </div>
                    </div>
