...
const JobOfferDetails: React.FC<JobOfferDetailsProps> = ({ jobId }) => {
  ...
  if (!jobOffer) {
    return null; // No renderizar nada si la oferta no existe
  }
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded-md">
                ...
                <span className="font-semibold text-gray-900 text-xs">
                  {jobOffer.sportGenres}
                </span>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded-md">
                <span className="text-gray-600 text-xs">Posición:</span>
                <span className="font-semibold text-gray-900 text-xs truncate ml-1">
                  {jobOffer.position || "N/E"}
                </span>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded-md">
                <span className="text-gray-600 text-xs">Contrato:</span>
                <span className="font-semibold text-gray-900 text-xs truncate ml-1">
                  {jobOffer.contractTypes}
                </span>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded-md">
                <span className="text-gray-600 text-xs">Duración:</span>
                <span className="font-semibold text-gray-900 text-xs truncate ml-1">
                  {jobOffer.contractDurations}
                </span>
              </div>
              <div className="flex justify-between items-center p-2 bg-gray-50 rounded-md">
