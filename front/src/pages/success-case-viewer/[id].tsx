  ...
  useEffect(() => {
    ...
    const fetchSuccessCase = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            `Error al cargar el caso de éxito: ${response.status}`
          );
        }
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        ...
        <meta
          name="description"
          content={successCase.testimonial.substring(0, 160)}
        />
      </Head>
              ...
              {successCase.longDescription ? (
                ...
                <div className="mt-6">
                  ...
                  <p className="mb-4 text-gray-700 leading-relaxed">
                    {successCase.name} es uno de los muchos talentos que han
                    encontrado su camino gracias a FutboLink, la plataforma que
                    conecta profesionales del fútbol con oportunidades reales en
                    todo el mundo.
                  </p>
                  <p className="mb-4 text-gray-700 leading-relaxed">
