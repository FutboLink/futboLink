      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-end space-x-4 mt-4 md:mt-0">
            <a
              href="https://www.facebook.com/profile.php?id=61574216832266"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl hover:text-verde-mas-claro"
            >
              <FaFacebook />
            </a>
            <a
              href="https://www.linkedin.com/company/futbolink/?viewAsMember=true"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl hover:text-verde-mas-claro"
            >
            ...
            <a
              href="https://www.youtube.com/@futbolink_oficial"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl hover:text-verde-mas-claro"
            >
            ...
            <a
              href="https://www.instagram.com/futbolink_/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl hover:text-verde-mas-claro"
            >
            ...
            <a
              href="https://www.tiktok.com/@futbolink_"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl hover:text-verde-mas-claro"
            >
            ...
            <a
              href="https://x.com/futbolink_"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-verde-mas-claro"
            >
              <Image
                src="/logoX.png"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center md:text-left">
            <div className="flex flex-col items-center md:items-start">
              <ul className="space-y-1">
                <li>
                  <Link href="/cursos" className="hover:text-verde-mas-claro">
                    Entrenamiento
                  </Link>
                </li>
                <li>
                  <Link href="/Help" className="hover:text-verde-mas-claro">
                    Ayuda (FAQs)
                  </Link>
                </li>
                <li>
                  <Link href="/videos" className="hover:text-verde-mas-claro">
                    Guía de uso (videos tutoriales)
                  </Link>
                </li>
                <li>
                  <Link href="/Subs" className="hover:text-verde-mas-claro">
                    Suscripciones
                  </Link>
                </li>
                <li>
                  <Link href="/News" className="hover:text-verde-mas-claro">
                    Noticias
                  </Link>
                </li>
              </ul>
            ...
            <div className="flex flex-col items-center md:items-start">
              <ul className="space-y-1">
                ...
                <li>
                  <Link href="/Login" className="hover:text-verde-mas-claro">
                    Acceder a mi cuenta
                  </Link>
                </li>
                <li>
