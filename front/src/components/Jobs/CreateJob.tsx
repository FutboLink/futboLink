...
const FormComponent = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto bg-white text-gray-700 rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-blue-600 p-6">
        ...
        <p className="text-center text-green-50 mt-2 text-sm">
          Completa todos los campos para publicar tu oferta
        </p>
      </div>

      {/* Advertencia */}
      <div className="mx-6 mt-6 bg-orange-50 border-l-4 border-orange-500 text-orange-700 p-4 rounded-lg shadow-sm">
      ...
      >
        <div className="flex flex-col">
          ...
          <input
            type="text"
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
            ...
            maxLength={80}
            placeholder="Ej: Jugador Profesional de Fútbol"
          />
        </div>
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Ciudad</label>
          <input
            type="text"
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Tipo de oferta</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Categoría</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Género deporte</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Modalidad</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Tipo de contrato</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Posición</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Moneda</label>
          <select
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Salario</label>
          <input
            type="text"
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Edad mínima</label>
          <input
            type="number"
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col">
          <label className="text-sm font-semibold mb-2 text-gray-700">Edad máxima</label>
          <input
            type="number"
            className="px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
        ...
        <div className="flex flex-col md:col-span-3">
          <label className="text-sm font-semibold mb-2 text-gray-700">Descripción</label>
          <textarea
            name="description"
            maxLength={1500}
            rows={4}
        ...
        <div className="flex flex-col md:col-span-3">
          <label className="text-sm font-semibold mb-2 text-gray-700">
            Competencias requeridas (Extras)
          </label>
        ...
        <div className="col-span-1 md:col-span-3 mt-6">
          <button
            type="submit"
            className="w-full inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg hover:from-green-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl font-semibold text-base disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={loading}
          >
            {loading ? (
              <>
        ...
        {error && (
          <div className="col-span-1 md:col-span-3 mt-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-lg">
            <div className="flex items-start gap-3">
        ...
        {successMessage && (
          <div className="col-span-1 md:col-span-3 mt-4 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
            <div className="flex items-start gap-3">
              <svg className="w-6 h-6 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <p className="text-green-700 font-semibold text-sm">{successMessage}</p>
            </div>
          </div>
        )}
      </form>
